...
from modules.scaled_screenshot_grid import create_scaled_grid_image
...
if __name__ == '__main__':
    ...
    screenshot_zoomed_with_grid = create_scaled_grid_image(zoomed_filename, (500, 100), (700, 300), 25)
